...
parser.add_argument('--testpath', default='H:/3d_model/photos/building4', help='./data/123')
...
parser.add_argument('--loadckpt', default='./checkpoints/32_25.ckpt', help='load a specific checkpoint')
parser.add_argument('--outdir', default='H:/3d_model/photos/test1/out2', help='output dir')
