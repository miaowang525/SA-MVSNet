...
parser.add_argument('--testpath', default='D:/blendedmvs/TankandTemples', help='testing data path')
parser.add_argument('--testlist', default='lists/tanks/all.txt', help='testing scan list')
parser.add_argument('--split', default='intermediate', help='select data')

parser.add_argument('--batch_size', type=int, default=1, help='testing batch size')
parser.add_argument('--n_views', type=int, default=7, help='num of view')
