...
# os.environ['CUDA_VISIBLE_DEVICES'] = '1'#看到那几张卡
#
# device_ids = [0]
...
parser.add_argument('--testpath', default="G:/3d_model/code/data/dtu", help='testing data path')
parser.add_argument('--testlist', default='lists/dtu2/test.txt', help='testing scan list')
...
if __name__ == '__main__':
    ...
    save_depth()
    img_wh = (640, 512)#1600, 1200  640, 512
