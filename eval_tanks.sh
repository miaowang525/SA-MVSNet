...
python eval.py --batch_size=1 --testpath=./data/dtu/ --geo_pixel_thres=1 --geo_depth_thres=0.01 --photo_thres 0.8 \
--testlist lists/dtu/test.txt --loadckpt=./checkpoints/model_000007.ckpt $@


python eval_tank.py --dataset=tanks --split intermediate --batch_size=1 --n_views 7 \
--testpath=D:\blendedmvs\TankandTemples --geo_pixel_thres=1 --geo_depth_thres=0.01 --loadckpt=./checkpoints/model_000007.ckpt$@
