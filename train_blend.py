...
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'#看到那几张卡
...
parser.add_argument('--trainpath', default='/home/d6813/MW/data/blendedmvs/', help='train datapath')
parser.add_argument('--valpath', help='validation datapath')
parser.add_argument('--trainlist', default='./lists/blend/val.txt', help='train list')
parser.add_argument('--vallist', default='./lists/blend/val.txt', help='validation list')
